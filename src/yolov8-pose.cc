...
int inference_yolov8_pose_model(rknn_app_context_t *app_ctx, image_buffer_t *img, object_detect_result_list *od_results)
{
    ...
    // letterbox
    std::cout<<"开始调用convert_image_with_letterbox"<<std::endl;
    ...
    std::cout<<"开始调用rknn_inputs_set"<<std::endl;
    ...
    std::cout<<"调用rknn_outputs_get"<<std::endl;
    ...
    std::cout<<"完成调用rknn_outputs_get"<<std::endl;
    // Post Process
    start_us = getCurrentTimeUs();
    ...
    std::cout<<"调用rknn_outputs_release"<<std::endl;
